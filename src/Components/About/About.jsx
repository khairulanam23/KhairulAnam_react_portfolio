...
import { Download, Send, Code } from 'lucide-react';
      ...
      <div className="container mx-auto px-4 py-16 md:py-24 grid md:grid-cols-2 gap-12 items-center">
        ...
        >
          <motion.p 
            ...
            style={{ color: isDarkMode ? 'var(--primary-light)' : 'var(--primary-color)' }}
          >
            Hello, I'm
          </motion.p>
          ...
          <motion.h2
            ...
            style={{ color: isDarkMode ? 'var(--primary-light)' : 'var(--primary-dark)' }}
          >
          ...
          >
            I specialize in building scalable and high-performance web applications using the MERN stack. With a passion for creating impactful user experiences, I deliver innovative solutions to complex challenges.
          </motion.p>
